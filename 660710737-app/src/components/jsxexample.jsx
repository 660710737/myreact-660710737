...
function JSXExamples() {
    ...
    const user = {
        ...
        lastName: 'หลักฐาน',
        age: 20,
        hobbies: ['แบดมินตัน', 'นอน', 'ฟังPodcast']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'หนังสือ', price: 220, inStock: true },
                        { id: 2, name: 'ไม้แบดมินตัน', price: 1890, inStock: true },
                        { id: 3, name: 'ไอแพด', price: 45000, inStock: false }
                    ].map(product => (
